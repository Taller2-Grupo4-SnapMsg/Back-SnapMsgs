...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id_post'], ['posts.id'], name='likes_id_post_fkey', ondelete='CASCADE'),
    ...
    sa.Column('content', sa.VARCHAR(length=800), autoincrement=False, nullable=True),
