...
@router.get("/posts/profile/{user_visited_email}/oldest_date/{oldest_date_str}/amount/{amount}", tags=["Posts"]) 
async def api_get_posts_from_user_visited(user_visited_email: str , oldest_date_str: str, amount: int, token: str = Header(...)):
    """
